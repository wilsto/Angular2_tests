System.register(['angular2/testing', 'angular2/core', 'angular2/platform/testing/browser', '../client/dev/todo/todo_cmp.js', '../client/dev/todo/todo_service.js'], function(exports_1) {
    ...
    var testing_1, core_1, testing_2, browser_1, todo_cmp_js_1, todo_service_js_1;
    var MockTodoService;
    return {
        setters:[
            ...
            function (todo_cmp_js_1_1) {
                todo_cmp_js_1 = todo_cmp_js_1_1;
            },
            function (todo_service_js_1_1) {
                todo_service_js_1 = todo_service_js_1_1;
            }],
        execute: function() {
            ...
            testing_1.describe('todo_component', function () {
                ...
                testing_1.beforeEachProviders(function () { return [core_1.provide(todo_service_js_1.TodoService, { useClass: MockTodoService })]; });
                testing_1.describe('creation', function () {
                    testing_1.it('should create the component correctly', testing_1.injectAsync([testing_1.TestComponentBuilder], function (tcb) {
                        return tcb.createAsync(todo_cmp_js_1.TodoCmp).then(function (fixture) {
...
//# sourceMappingURL=todo_component_test.js.map